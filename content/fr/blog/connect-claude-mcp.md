...
- **Traduire votre profil** — demander à Claude de créer une version française (ou autre langue) de votre CV
...
> *« Mon profil n'existe qu'en anglais — peux-tu traduire les expériences en français pour que je puisse générer un CV français ? »*
